...
- applies only to the named distribution or environment;
- adds guidance instead of copying or rewriting the canonical workflow;
- keeps credentials out of files, commands, reports, and examples; and
- states compatibility limits for any private runtime or adapter it describes.
